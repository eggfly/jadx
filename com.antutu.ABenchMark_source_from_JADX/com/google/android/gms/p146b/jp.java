...
public class jp {
    ...
    public static int m13566a(byte[] r6, int r7, int r8, int r9) {
        /*
    ...
    L_0x006b:
        ...
        goto L_0x0047;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.b.jp.a(byte[], int, int, int):int");
    }
}
