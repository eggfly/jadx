...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    class C35801 extends TypeAdapter<T> {
        ...
        C35801(boolean z, boolean z2, Gson gson, TypeToken typeToken) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
        ...
        return (excludeClass || excludeClass2) ? new C35801(excludeClass2, excludeClass, gson, typeToken) : null;
    }
