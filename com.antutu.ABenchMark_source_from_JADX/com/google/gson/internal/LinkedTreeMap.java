...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    static class C35841 implements Comparator<Comparable> {
        C35841() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C35851 extends LinkedTreeMapIterator<Entry<K, V>> {
            C35851() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C35861 extends LinkedTreeMapIterator<K> {
            C35861() {
                super();
            }
