...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
    ...
    static /* synthetic */ class C36251 {
        static final /* synthetic */ int[] f12291x9a7fbd92;

        static {
            f12291x9a7fbd92 = new int[Mode.values().length];
            try {
                f12291x9a7fbd92[Mode.MANUAL_REFRESH_ONLY.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f12291x9a7fbd92[Mode.PULL_FROM_END.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f12291x9a7fbd92[Mode.PULL_FROM_START.ordinal()] = 3;
    ...
    protected void handleStyledAttributes(TypedArray typedArray) {
        ...
        this.mListViewExtrasEnabled = typedArray.getBoolean(C3628R.styleable.PullToRefresh_ptrListViewExtrasEnabled, true);
        if (this.mListViewExtrasEnabled) {
            ...
            if (!typedArray.hasValue(C3628R.styleable.PullToRefresh_ptrScrollingWhileRefreshingEnabled)) {
    ...
    protected void onRefreshing(boolean z) {
        ...
        switch (C36251.f12291x9a7fbd92[getCurrentMode().ordinal()]) {
