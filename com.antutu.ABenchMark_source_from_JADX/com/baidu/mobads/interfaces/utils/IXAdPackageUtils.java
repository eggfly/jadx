    ...
    public static class ApkInfo {
        ...
        public JSONObject toJSONObject() {
            ...
            try {
                ...
                jSONObject.put(IXAdRequestInfo.f6909V, this.versionName);
                jSONObject.put("c", this.versionCode);
                jSONObject.put("s", new File(this.f6913a.applicationInfo.sourceDir).lastModified());
