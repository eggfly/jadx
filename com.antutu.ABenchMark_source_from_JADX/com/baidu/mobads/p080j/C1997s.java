...
/* renamed from: com.baidu.mobads.j.s */
public class C1997s implements IXAdViewUtils {
    private boolean m7477a(View view) {
        return view.getWidth() > 15 && view.getHeight() > 15;
    }

    public int getViewState(View view) {
        return !isScreenOn(view.getContext()) ? 4 : !isAdViewShown(view) ? 1 : !m7477a(view) ? 6 : !isVisible(view, 50) ? 3 : 0;
    }
    ...
    public boolean isAdViewOutsideScreen(View view) {
        ...
        Rect windowRect = C1991m.m7449a().m7464m().getWindowRect(view.getContext());
