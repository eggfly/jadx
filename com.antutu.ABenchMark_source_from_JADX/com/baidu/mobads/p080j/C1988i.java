...
public class C1988i implements IXAdIOUtils {
    public void copyFileFromAssetsTo(Context context, String str, String str2) {
        try {
            C1991m.m7449a().m7462k().copyFileInputStream(context.getAssets().open(str), str2);
        } catch (Throwable e) {
    ...
    public File getExternalFilesDir(Context context) {
        try {
            return C1991m.m7449a().m7465n().isUseOldStoragePath() ? Environment.getExternalStorageDirectory() : context.getExternalFilesDir(null);
        } catch (Exception e) {
            C1991m.m7449a().m7457f().m7400e("XAdIOUtils", e.getMessage());
            return null;
        }
    }
