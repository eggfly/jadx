...
public class MsgConstant {
    ...
    static long f14088a = 0;
    static final long f14089b = 60000;
    protected static final String f14090c = "TD";
    private static String f14091d;
    private static String f14092e;
    private static String f14093f;

    static {
        HTTPS_ERROR = "javax.net.ssl.SSLHandshakeException";
        f14091d = C4213a.f14288a;
        f14093f = HttpConstant.HTTPS;
        String str = f14093f + HttpConstant.SCHEME_SPLIT + f14091d + "/";
