...
public class Constants {
    ...
    public enum Operate {
        ASK_VERSION(Constants.RELEASE),
        REPORT_VERSION(Constants.PREVIEW),
        TRY_ELECTION(Constants.DEBUG),
        START_ELECTION(Constants.DB_VERSION),
        RESULT_ELECTION(Constants.COMMAND_UNBIND_USER),
        PING_ELECTION(Constants.COMMAND_BIND_SERVICE);
