...
public class WXVideoObject implements IMediaObject {
    ...
    public boolean checkArgs() {
        if ((this.videoUrl == null || this.videoUrl.length() == 0) && (this.videoLowBandUrl == null || this.videoLowBandUrl.length() == 0)) {
            C0979d.m4390a().m4375d("both arguments are null", new Object[0]);
            return false;
        } else if (this.videoUrl != null && this.videoUrl.length() > 10240) {
            C0979d.m4390a().m4375d("checkArgs fail, videoUrl is too long", new Object[0]);
            return false;
        } else if (this.videoLowBandUrl == null || this.videoLowBandUrl.length() <= 10240) {
            return true;
        } else {
            C0979d.m4390a().m4375d("checkArgs fail, videoLowBandUrl is too long", new Object[0]);
            return false;
        }
    }
