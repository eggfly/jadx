...
/* renamed from: cn.sharesdk.tencent.qzone.c */
public class C1027c extends C0916d {
    private String f3463d;
    private String f3464e;

    public C1027c(C0937c c0937c) {
        super(c0937c);
    }
    ...
    public void m4575a() {
        ...
        try {
            ...
            bundle.putString("scope", this.f3464e);
            bundle.putString("client_id", this.f3463d);
    ...
    public void m4576a(int i, int i2, Intent intent) {
        this.a.finish();
        if (i2 == 0) {
            if (this.c != null) {
                this.c.onCancel();
    ...
    public void m4577a(String str, String str2) {
        this.f3463d = str;
        this.f3464e = str2;
    }
}
