...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    class C02092 extends WorkerRunnable<Params, Result> {
        C02092() {
            super();
        }
    ...
    class C02103 extends FutureTask<Result> {
        C02103(Callable callable) {
            super(callable);
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C02092();
        this.mFuture = new C02103(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor executor, Params... paramsArr) {
        if (this.mStatus != Status.PENDING) {
            switch (C02114.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
