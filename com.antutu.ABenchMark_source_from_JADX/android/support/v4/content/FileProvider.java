...
public class FileProvider extends ContentProvider {
    ...
    private static PathStrategy parsePathStrategy(Context context, String str) {
        ...
        XmlResourceParser loadXmlMetaData = context.getPackageManager().resolveContentProvider(str, SpdyProtocol.SLIGHTSSLV2).loadXmlMetaData(context.getPackageManager(), META_DATA_FILE_PROVIDER_PATHS);
