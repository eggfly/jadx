...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflaterFactory {
    ...
    class C01895 extends AnimateOnHWLayerIfNeededListener {
        final /* synthetic */ Fragment val$fragment;

        C01895(View view, Animation animation, Fragment fragment) {
    ...
    public void popBackStack() {
        enqueueAction(new C01862(), HONEYCOMB);
    }
    ...
    public void popBackStack(int i, int i2) {
        ...
        enqueueAction(new C01884(i, i2), HONEYCOMB);
    }

    public void popBackStack(String str, int i) {
        enqueueAction(new C01873(str, i), HONEYCOMB);
    }
