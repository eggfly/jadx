...
public class FragmentActivity extends BaseFragmentActivityHoneycomb implements OnRequestPermissionsResultCallback, RequestPermissionsRequestCodeValidator {
    ...
    private void requestPermissionsFromFragment(Fragment fragment, String[] strArr, int i) {
        if (i == -1) {
            ...
            try {
                ...
                ActivityCompat.requestPermissions(this, strArr, ((allocateRequestIndex(fragment) + MSG_REALLY_STOPPED) << 16) + (Platform.CUSTOMER_ACTION_MASK & i));
            } finally {
    ...
    private static String viewToString(View view) {
        ...
        if (id != -1) {
            ...
            if (!(id == 0 || resources == null)) {
                String str;
                switch (SystemBarTintManager.DEFAULT_TINT_COLOR & id) {
    ...
    protected void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (i3 != 0) {
            ...
            if (findFragmentByWho == null) {
                ...
                findFragmentByWho.onActivityResult(Platform.CUSTOMER_ACTION_MASK & i, i2, intent);
                return;
            }
        }
    ...
    public void startActivityFromFragment(Fragment fragment, Intent intent, int i, Bundle bundle) {
        ...
        if (i == -1) {
            ...
            ActivityCompat.startActivityForResult(this, intent, ((allocateRequestIndex(fragment) + MSG_REALLY_STOPPED) << 16) + (Platform.CUSTOMER_ACTION_MASK & i), bundle);
            this.mStartedActivityFromFragment = false;
        }
    }
