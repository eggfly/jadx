...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, Runnable {
    ...
    class C01781 implements ViewRetriever {
    ...
    class C01792 implements OnPreDrawListener {
        final /* synthetic */ Fragment val$inFragment;
        ...
        C01792(View view, Object obj, ArrayList arrayList, TransitionState transitionState, boolean z, Fragment fragment, Fragment fragment2) {
    ...
    class C01803 implements OnPreDrawListener {
        final /* synthetic */ int val$containerId;
        final /* synthetic */ View val$sceneRoot;
        final /* synthetic */ TransitionState val$state;
        final /* synthetic */ Object val$transition;

        C01803(View view, TransitionState transitionState, int i, Object obj) {
            this.val$sceneRoot = view;
            this.val$state = transitionState;
        ...
        if (sharedElementTransition != null) {
            ...
            if (map.isEmpty()) {
                ...
                if (mergeTransitions != null) {
                    FragmentTransitionCompat21.addTransitionTargets(enterTransition, obj, view, c01781, transitionState.nonExistentView, transitionState.enteringEpicenterView, transitionState.nameOverrides, arrayList2, map, arrayMap, arrayList3);
    ...
    private void excludeHiddenFragmentsAfterEnter(View view, TransitionState transitionState, int i, Object obj) {
        view.getViewTreeObserver().addOnPreDrawListener(new C01803(view, transitionState, i, obj));
    }
    ...
    private void prepareSharedElementTransition(TransitionState transitionState, View view, Object obj, Fragment fragment, Fragment fragment2, boolean z, ArrayList<View> arrayList) {
        view.getViewTreeObserver().addOnPreDrawListener(new C01792(view, obj, arrayList, transitionState, z, fragment, fragment2));
    }
    ...
    public void run() {
        ...
        if (!this.mAddToBackStack || this.mIndex >= 0) {
            ...
            Op op = this.mHead;
            while (op != null) {
                int i3 = transitionState != null ? OP_NULL : op.enterAnim;
                int i4 = transitionState != null ? OP_NULL : op.exitAnim;
                Fragment fragment;
                switch (op.cmd) {
                    case OP_ADD /*1*/:
                        fragment = op.fragment;
