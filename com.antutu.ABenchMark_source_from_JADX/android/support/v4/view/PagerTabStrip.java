...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public PagerTabStrip(Context context, AttributeSet attributeSet) {
        ...
        this.mPrevText.setOnClickListener(new C02821());
        this.mNextText.setFocusable(true);
        this.mNextText.setOnClickListener(new C02832());
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.mDrawFullUnderline) {
            this.mTabPaint.setColor(SystemBarTintManager.DEFAULT_TINT_COLOR | (this.mIndicatorColor & ViewCompat.MEASURED_SIZE_MASK));
    ...
    public void setBackgroundColor(int i) {
        ...
        if (!this.mDrawFullUnderlineSet) {
            this.mDrawFullUnderline = (SystemBarTintManager.DEFAULT_TINT_COLOR & i) == 0;
        }
    }
