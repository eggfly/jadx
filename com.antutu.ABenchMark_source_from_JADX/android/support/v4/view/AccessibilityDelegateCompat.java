...
public class AccessibilityDelegateCompat {
    ...
    static class AccessibilityDelegateIcsImpl extends AccessibilityDelegateStubImpl {
        ...
        class C02771 implements AccessibilityDelegateBridge {
        ...
        public Object newAccessiblityDelegateBridge(AccessibilityDelegateCompat accessibilityDelegateCompat) {
            return AccessibilityDelegateCompatIcs.newAccessibilityDelegateBridge(new C02771(accessibilityDelegateCompat));
        }
    ...
    static class AccessibilityDelegateJellyBeanImpl extends AccessibilityDelegateIcsImpl {
        ...
        class C02781 implements AccessibilityDelegateBridgeJellyBean {
            final /* synthetic */ AccessibilityDelegateCompat val$compat;

            C02781(AccessibilityDelegateCompat accessibilityDelegateCompat) {
                this.val$compat = accessibilityDelegateCompat;
            }
        ...
        public Object newAccessiblityDelegateBridge(AccessibilityDelegateCompat accessibilityDelegateCompat) {
            return AccessibilityDelegateCompatJellyBean.newAccessibilityDelegateBridge(new C02781(accessibilityDelegateCompat));
        }
