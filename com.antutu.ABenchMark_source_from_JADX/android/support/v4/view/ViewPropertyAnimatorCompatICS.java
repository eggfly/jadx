...
class ViewPropertyAnimatorCompatICS {
    ...
    static class C02931 extends AnimatorListenerAdapter {
        final /* synthetic */ ViewPropertyAnimatorListener val$listener;
        final /* synthetic */ View val$view;

        C02931(ViewPropertyAnimatorListener viewPropertyAnimatorListener, View view) {
    ...
    public static void m828x(View view, float f) {
        view.animate().x(f);
    }
    ...
    public static void m829y(View view, float f) {
        view.animate().y(f);
    }
