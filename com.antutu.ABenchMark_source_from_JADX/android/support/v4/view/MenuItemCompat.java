...
public final class MenuItemCompat {
    ...
    static class IcsMenuVersionImpl extends HoneycombMenuVersionImpl {
        ...
        class C02811 implements SupportActionExpandProxy {
            final /* synthetic */ OnActionExpandListener val$listener;

            C02811(OnActionExpandListener onActionExpandListener) {
        ...
        public MenuItem setOnActionExpandListener(MenuItem menuItem, OnActionExpandListener onActionExpandListener) {
            return onActionExpandListener == null ? MenuItemCompatIcs.setOnActionExpandListener(menuItem, null) : MenuItemCompatIcs.setOnActionExpandListener(menuItem, new C02811(onActionExpandListener));
        }
    }
