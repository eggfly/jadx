...
class HoneycombMr1AnimatorCompatProvider implements AnimatorProvider {
    ...
    static class HoneycombValueAnimatorCompat implements ValueAnimatorCompat {
        ...
        class C01741 implements AnimatorUpdateListener {
            final /* synthetic */ AnimatorUpdateListenerCompat val$animatorUpdateListener;

            C01741(AnimatorUpdateListenerCompat animatorUpdateListenerCompat) {
        ...
        public void addUpdateListener(AnimatorUpdateListenerCompat animatorUpdateListenerCompat) {
            if (this.mWrapped instanceof ValueAnimator) {
                ((ValueAnimator) this.mWrapped).addUpdateListener(new C01741(animatorUpdateListenerCompat));
            }
        }
