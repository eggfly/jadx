...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    class C03111 extends Animation {
    ...
    class C03122 implements AnimationListener {
        final /* synthetic */ Ring val$ring;
    ...
    class C03133 implements Callback {
        C03133() {
        }
    ...
    public MaterialProgressDrawable(Context context, View view) {
        ...
        iArr[LARGE] = SystemBarTintManager.DEFAULT_TINT_COLOR;
        this.COLORS = iArr;
        this.mAnimators = new ArrayList();
        this.mCallback = new C03133();
        this.mParent = view;
    ...
    private void setupAnimators() {
        Ring ring = this.mRing;
        Animation c03111 = new C03111(ring);
        c03111.setRepeatCount(-1);
        c03111.setRepeatMode(DEFAULT);
        c03111.setInterpolator(LINEAR_INTERPOLATOR);
        c03111.setAnimationListener(new C03122(ring));
        this.mAnimation = c03111;
    }
