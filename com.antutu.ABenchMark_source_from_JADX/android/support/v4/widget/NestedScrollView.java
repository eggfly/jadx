...
public class NestedScrollView extends FrameLayout implements NestedScrollingChild, NestedScrollingParent, ScrollingView {
    ...
    static class SavedState extends BaseSavedState {
        ...
        static class C03141 implements Creator<SavedState> {
            C03141() {
            }
    ...
    public boolean arrowScroll(int i) {
        ...
        if (findNextFocus == null || !isWithinDeltaOfScreen(findNextFocus, maxScrollAmount, getHeight())) {
            ...
            } else if (i == SpdyProtocol.CDN && getChildCount() > 0) {
        ...
        if (canScroll()) {
            ...
            switch (keyEvent.getKeyCode()) {
                ...
                case MsgConstant.CACHE_LOG_COUNT_MAX /*20*/:
                    return !keyEvent.isAltPressed() ? arrowScroll(SpdyProtocol.CDN) : fullScroll(SpdyProtocol.CDN);
            ...
            findFocus = FocusFinder.getInstance().findNextFocus(this, findFocus, SpdyProtocol.CDN);
            boolean z = (findFocus == null || findFocus == this || !findFocus.requestFocus(SpdyProtocol.CDN)) ? false : true;
            return z;
        }
    }
