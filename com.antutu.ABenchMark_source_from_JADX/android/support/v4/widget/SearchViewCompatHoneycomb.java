...
class SearchViewCompatHoneycomb {
    ...
    static class C03171 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C03171(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C03182 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C03182(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
