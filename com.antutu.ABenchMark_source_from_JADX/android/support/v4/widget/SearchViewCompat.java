...
public final class SearchViewCompat {
    ...
    static class SearchViewCompatHoneycombImpl extends SearchViewCompatStubImpl {
        ...
        class C03151 implements OnQueryTextListenerCompatBridge {
            ...
            C03151(OnQueryTextListenerCompat onQueryTextListenerCompat) {
        ...
        class C03162 implements OnCloseListenerCompatBridge {
            ...
            C03162(OnCloseListenerCompat onCloseListenerCompat) {
        ...
        public Object newOnCloseListener(OnCloseListenerCompat onCloseListenerCompat) {
            return SearchViewCompatHoneycomb.newOnCloseListener(new C03162(onCloseListenerCompat));
        }

        public Object newOnQueryTextListener(OnQueryTextListenerCompat onQueryTextListenerCompat) {
            return SearchViewCompatHoneycomb.newOnQueryTextListener(new C03151(onQueryTextListenerCompat));
        }
