...
class TransportMediatorJellybeanMR2 {
    ...
    class C02431 implements OnWindowAttachListener {
        C02431() {
        }
    ...
    class C02442 implements OnWindowFocusChangeListener {
        C02442() {
        }
    ...
    class C02453 extends BroadcastReceiver {
        C02453() {
        }
    ...
    class C02464 implements OnAudioFocusChangeListener {
        C02464() {
        }
    ...
    class C02475 implements OnGetPlaybackPositionListener {
        C02475() {
        }
    ...
    class C02486 implements OnPlaybackPositionUpdateListener {
        C02486() {
        }
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportMediatorCallback) {
        this.mWindowAttachListener = new C02431();
        this.mWindowFocusListener = new C02442();
        this.mMediaButtonReceiver = new C02453();
        this.mAudioFocusChangeListener = new C02464();
        this.mGetPlaybackPositionListener = new C02475();
        this.mPlaybackPositionUpdateListener = new C02486();
        this.mPlayState = 0;
