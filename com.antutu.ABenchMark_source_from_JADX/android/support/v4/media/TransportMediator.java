...
public class TransportMediator extends TransportController {
    ...
    class C02411 implements TransportMediatorCallback {
        C02411() {
        }
    ...
    class C02422 implements Callback {
        C02422() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer transportPerformer) {
        ...
        this.mTransportKeyCallback = new C02411();
        this.mKeyEventCallback = new C02422();
