...
public final class PrintHelper {
    ...
    private static final class PrintHelperKitkatImpl implements PrintHelperVersionImpl {
        ...
        class C02651 implements android.support.v4.print.PrintHelperKitkat.OnPrintFinishCallback {
            final /* synthetic */ OnPrintFinishCallback val$callback;

            C02651(OnPrintFinishCallback onPrintFinishCallback) {
        ...
        class C02662 implements android.support.v4.print.PrintHelperKitkat.OnPrintFinishCallback {
            final /* synthetic */ OnPrintFinishCallback val$callback;

            C02662(OnPrintFinishCallback onPrintFinishCallback) {
                this.val$callback = onPrintFinishCallback;
            }
        ...
        public void printBitmap(String str, Bitmap bitmap, OnPrintFinishCallback onPrintFinishCallback) {
            ...
            if (onPrintFinishCallback != null) {
                onPrintFinishCallback2 = new C02651(onPrintFinishCallback);
            }
        ...
        public void printBitmap(String str, Uri uri, OnPrintFinishCallback onPrintFinishCallback) {
            android.support.v4.print.PrintHelperKitkat.OnPrintFinishCallback onPrintFinishCallback2 = null;
            if (onPrintFinishCallback != null) {
                onPrintFinishCallback2 = new C02662(onPrintFinishCallback);
            }
