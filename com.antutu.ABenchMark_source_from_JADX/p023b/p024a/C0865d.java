...
/* renamed from: b.a.d */
public class C0865d extends cn {
    private Context f2906a;
    private String f2907b;
    private String f2908c;

    /* renamed from: b.a.d.1 */
    class C08641 implements HostnameVerifier {
        final /* synthetic */ C0865d f2905a;

        C08641(C0865d c0865d) {
            this.f2905a = c0865d;
        }
    ...
    public static String m3834a(String str, String str2) {
        try {
    ...
    private java.lang.String m3835b(java.lang.String r8) {
        /*
        r7 = this;
        r3 = 0;
        r0 = "ro.yunos.openuuid";
        r1 = "";
        r0 = p023b.p024a.C0865d.m3834a(r0, r1);
        r7.f2908c = r0;
        r0 = r7.f2908c;
    ...
    L_0x003a:
        ...
        r1 = new b.a.d$1;	 Catch:{ Exception -> 0x017f, all -> 0x015b }
    ...
    L_0x00f1:
        ...
        r7.f2908c = r1;	 Catch:{ Exception -> 0x00d2, all -> 0x016d }
    L_0x00f7:
        r3 = r4;
        goto L_0x00d7;
    L_0x00f9:
    ...
    L_0x019d:
        ...
        goto L_0x00d7;
        */
        throw new UnsupportedOperationException("Method not decompiled: b.a.d.b(java.lang.String):java.lang.String");
    }

    public String m3836a() {
        try {
            if (!(TextUtils.isEmpty(C0865d.m3834a("ro.yunos.version", BuildConfig.FLAVOR)) || this.f2906a == null)) {
                SharedPreferences a = C0888r.m3932a(this.f2906a);
                if (a != null) {
                    Object string = a.getString("yosuid", BuildConfig.FLAVOR);
                    if (!TextUtils.isEmpty(string)) {
                        return string;
                    }
                    this.f2908c = m3835b("23346339");
                    if (!(TextUtils.isEmpty(this.f2908c) || this.f2906a == null || a == null)) {
                        Editor edit = a.edit();
                        if (edit != null) {
                            edit.putString("yosuid", this.f2908c).commit();
                        }
                    }
                    return this.f2908c;
                }
