        ...
        this.DrawAxes = function ()
        {
            ...
            co.beginPath();
                ...
                if (prop['chart.noxaxis'] == false && prop['chart.noaxes'] == false) {
                    co.moveTo(this.gutterLeft +0.001, 0.001);
                    co.lineTo(ca.width - this.gutterRight + 0.001, 0.001);
                }
            ...
            */
            if (typeof(prop['chart.labels']) == 'object') {
                ...
                */
                ...
                // Draw the X tickmarks
                var i=0;
                var myscore = prop['chart.myscore'];
                for (y=this.gutterTop + (yTickGap / 2); y<=ca.height - this.gutterBottom; y+=yTickGap) {
                    ...
                    var info = ":  " +  this.data[i].toFixed(0);
                    if (i == myscore) {
                        color = '#999999';
                    } else {
                        color = '#666666';
                    ...
                    RG.text2(this, {
                        ...
                        'y': y,
                        'color':color,
                        'text': String(prop['chart.labels'][i++] + info),
                        'halign': halign,
                        'valign': 'center',
                        'tag': 'labels'
                    });
