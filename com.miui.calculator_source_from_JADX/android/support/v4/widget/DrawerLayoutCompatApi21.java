...
class DrawerLayoutCompatApi21 {
    private static final int[] f1076a;
    ...
    static class InsetsListener implements OnApplyWindowInsetsListener {
        ...
        public WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
            ((DrawerLayoutImpl) view).m2117a(windowInsets, windowInsets.getSystemWindowInsetTop() > 0);
    ...
    static {
        f1076a = new int[]{16843828};
    }

    public static void m2158a(View view) {
    ...
    public static void m2159a(View view, Object obj, int i) {
    ...
    public static void m2160a(MarginLayoutParams marginLayoutParams, Object obj, int i) {
        obj = (WindowInsets) obj;
        if (i == 3) {
            obj = obj.replaceSystemWindowInsets(obj.getSystemWindowInsetLeft(), obj.getSystemWindowInsetTop(), 0, obj.getSystemWindowInsetBottom());
        } else if (i == 5) {
    ...
    public static int m2156a(Object obj) {
        return obj != null ? ((WindowInsets) obj).getSystemWindowInsetTop() : 0;
    }

    public static Drawable m2157a(Context context) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(f1076a);
        try {
