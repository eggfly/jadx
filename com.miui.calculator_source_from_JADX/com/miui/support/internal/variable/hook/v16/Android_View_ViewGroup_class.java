...
public class Android_View_ViewGroup_class extends com.miui.support.internal.variable.hook.Android_View_ViewGroup_class {
    ...
    static {
        com_android_internal_R_styleable = getClass("com.android.internal.R$styleable");
        R_styleable_ViewGroup_clipChildren = Field.of(com_android_internal_R_styleable, "ViewGroup_clipChildren", Field.INT_SIGNATURE_PRIMITIVE).getInt(null);
        ...
        DESCENDANT_FOCUSABILITY_FLAGS = (int[]) Field.of(ViewGroup.class, "DESCENDANT_FOCUSABILITY_FLAGS", "[I").get(null);
    }
    ...
    protected void handleAddInArray(long j, ViewGroup viewGroup, View view, int i) {
        ...
        if (!(viewGroup instanceof AbsListView)) {
            TaggingDrawableHelper.m4252a(viewGroup);
        }
    }

    protected void originalAddInArray(long j, ViewGroup viewGroup, View view, int i) {
        throw new IllegalStateException("com.miui.internal.variable.hook.v16.Android_View_ViewGroup_class.originalAddInArray(long, ViewGroup, View, int)");
    }
    ...
    protected void originalRemoveFromArray(long j, ViewGroup viewGroup, int i) {
        throw new IllegalStateException("com.miui.internal.variable.hook.v16.Android_View_ViewGroup_class.originalRemoveFromArray(long, ViewGroup, int)");
    }
    ...
    protected void originalRemoveFromArray(long j, ViewGroup viewGroup, int i, int i2) {
        throw new IllegalStateException("com.miui.internal.variable.hook.v16.Android_View_ViewGroup_class.originalRemoveFromArray(long, ViewGroup, int, int)");
    }
    ...
    protected void originalOnChildVisibilityChanged(long j, ViewGroup viewGroup, View view, int i, int i2) {
        throw new IllegalStateException("com.miui.internal.variable.hook.v16.Android_View_ViewGroup_class.originalOnChildVisibilityChanged(long, ViewGroup, View, int, int)");
    }
    ...
    protected boolean originalResolveLayoutDirection(long j, ViewGroup viewGroup) {
        throw new IllegalStateException("com.miui.internal.variable.hook.v16.Android_View_ViewGroup_class.originalResolveLayoutDirection(long, ViewGroup)");
    }
    ...
    protected void originalInitFromAttributes(long j, ViewGroup viewGroup, Context context, AttributeSet attributeSet) {
        throw new IllegalStateException("com.miui.internal.variable.hook.v16.Android_View_ViewGroup_class.originalInitFromAttributes(long, ViewGroup, Context, AttributeSet)");
    }
    ...
    protected void original_init_(long j, ViewGroup viewGroup, Context context, AttributeSet attributeSet) {
        throw new IllegalStateException("com.miui.internal.variable.hook.v16.Android_View_ViewGroup_class.original_init_(long, ViewGroup, Context, AttributeSet)");
    }
    ...
    protected void original_init_(long j, ViewGroup viewGroup, Context context, AttributeSet attributeSet, int i) {
        throw new IllegalStateException("com.miui.internal.variable.hook.v16.Android_View_ViewGroup_class.original_init_(long, ViewGroup, Context, AttributeSet, int)");
    }
    ...
    protected void initFromAttributes(ViewGroup viewGroup, Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TaggingDrawableHelper.m4253a(viewGroup, attributeSet);
    }
