...
public class Android_View_ViewGroup_class extends com.miui.support.internal.variable.hook.v19.Android_View_ViewGroup_class {
    ...
    static {
        R_styleable_ViewGroup_transitionGroup = Field.of(com_android_internal_R_styleable, "ViewGroup_transitionGroup", Field.INT_SIGNATURE_PRIMITIVE).getInt(null);
        R_styleable_ViewGroup_touchscreenBlocksFocus = 0;
        setTransitionGroup = Method.of(ViewGroup.class, "setTransitionGroup", "(Z)V");
