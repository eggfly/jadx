...
public final class ve extends ul {
    ...
    public String DW(uf ufVar, boolean z) {
        return ul.j6((aay) ((ud) ufVar).FH(), 4);
    }
    ...
    public boolean DW(uf ufVar) {
        zx tp = ufVar.tp();
        if (!(ufVar instanceof ud) || tp.m_() != 1 || !ul.DW(tp.DW(0).VH())) {
            return false;
        }
        aah FH = ((ud) ufVar).FH();
    ...
    public void j6(acr acr, uf ufVar) {
        ul.j6(acr, ul.j6(ufVar, ul.DW(ufVar.tp().DW(0).VH(), ((aay) ((ud) ufVar).FH()).tp() & 15)));
    }
}
