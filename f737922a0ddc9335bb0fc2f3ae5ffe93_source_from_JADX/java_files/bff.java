...
public class bff implements bek {
    ...
    public void j6(boolean z, bel bel) {
        if (bel instanceof bft) {
            bft bft = (bft) bel;
            byte[] j6 = bft.j6();
            ...
            this.FH = bhf.DW(j6);
            if (bft.DW() != null) {
                this.j6 = j6(z, ((bfs) bft.DW()).j6());
            }
        } else if (bel instanceof bfs) {
            this.j6 = j6(z, ((bfs) bel).j6());
        } else if (bel != null) {
            throw new IllegalArgumentException("invalid parameter passed to GOST28147 init - " + bel.getClass().getName());
        }
    }
    ...
    public int j6(byte[] bArr, int i, byte[] bArr2, int i2) {
        if (this.j6 == null) {
            ...
            throw new bem("input buffer too short");
        } else if (i2 + 8 > bArr2.length) {
            throw new bem("output buffer too short");
        } else {
    ...
    public static byte[] j6(String str) {
        byte[] bArr = (byte[]) we.get(bhl.j6(str));
        if (bArr != null) {
            return bhf.DW(bArr);
        }
