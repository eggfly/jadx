...
public interface ad extends IInterface {
    ...
    public static abstract class a extends Binder implements ad {
        ...
        private static class a implements ad {
            ...
            public IBinder j6(agg agg, String str, cr crVar, int i) {
        ...
        public static ad j6(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case ProxyTextView.TYPEFACE_SANS /*1*/:
                    ...
                    IBinder j6 = j6(agg$a.j6(parcel.readStrongBinder()), parcel.readString(), com.google.android.gms.internal.cr.a.j6(parcel.readStrongBinder()), parcel.readInt());
    ...
    IBinder j6(agg agg, String str, cr crVar, int i);
}
