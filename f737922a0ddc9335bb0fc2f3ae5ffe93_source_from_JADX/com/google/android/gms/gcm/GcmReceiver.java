...
public class GcmReceiver extends WakefulBroadcastReceiver {
    ...
    static {
        j6 = "gcm.googleapis.com/refresh";
    }

    private void FH(Context context, Intent intent) {
    ...
    private void Hw(Context context, Intent intent) {
    ...
    public void DW(Context context, Intent intent) {
        FH(context, intent);
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if ("com.google.android.c2dm.intent.REGISTRATION".equals(intent.getAction()) || "google.com/iid".equals(stringExtra) || j6.equals(stringExtra)) {
