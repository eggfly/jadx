...
public interface du extends IInterface {
    ...
    public static abstract class a extends Binder implements du {
        ...
        public static du j6(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.purchase.client.IInAppPurchaseListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof du)) ? new a(iBinder) : (du) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case ProxyTextView.TYPEFACE_SANS /*1*/:
                    ...
                    j6(com.google.android.gms.internal.dt.a.j6(parcel.readStrongBinder()));
