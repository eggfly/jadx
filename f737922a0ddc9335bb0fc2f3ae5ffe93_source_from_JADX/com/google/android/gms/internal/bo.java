...
public interface bo extends IInterface {
    ...
    public static abstract class a extends Binder implements bo {
        ...
        private static class a implements bo {
            ...
            public void j6(bl blVar, String str) {
        ...
        public static bo j6(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case ProxyTextView.TYPEFACE_SANS /*1*/:
                    ...
                    j6(com.google.android.gms.internal.bl.a.j6(parcel.readStrongBinder()), parcel.readString());
