...
public final class r {
    protected static final Charset DW;
    public static final Object FH;
    protected static final Charset j6;

    static {
        j6 = Charset.forName("UTF-8");
        DW = Charset.forName("ISO-8859-1");
        FH = new Object();
    }
    ...
    public static int j6(long[] jArr) {
    ...
    public static void j6(n nVar, n nVar2) {
        if (nVar.J0 != null) {
            nVar2.J0 = (p) nVar.J0.clone();
        }
    }
    ...
    public static boolean j6(long[] jArr, long[] jArr2) {
