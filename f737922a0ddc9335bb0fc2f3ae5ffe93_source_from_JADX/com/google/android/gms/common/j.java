...
class j {
    ...
    static abstract class a extends com.google.android.gms.common.internal.x.a {
        private int j6;

        protected a(byte[] bArr) {
            com.google.android.gms.common.internal.b.DW(bArr.length == 25, "cert hash data has incorrect length. length=" + bArr.length);
            this.j6 = Arrays.hashCode(bArr);
        }

        protected static byte[] j6(String str) {
            try {
        ...
        public boolean equals(Object obj) {
            ...
            try {
                ...
                return Arrays.equals(FH(), (byte[]) agh.j6(j6));
    ...
    static abstract class c extends a {
        private static final WeakReference<byte[]> DW;
        private WeakReference<byte[]> j6;

        static {
            DW = new WeakReference(null);
        }
        ...
        byte[] FH() {
            byte[] bArr;
            synchronized (this) {
                bArr = (byte[]) this.j6.get();
                if (bArr == null) {
                    bArr = Hw();
                    this.j6 = new WeakReference(bArr);
                }
            }
            return bArr;
        }

        protected abstract byte[] Hw();
    }
