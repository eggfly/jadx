...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    class C02343 extends BaseAnimationListener {
        C02343() {
            super(null);
        }
    ...
    class C02354 extends BaseAnimationListener {
        C02354() {
            super(null);
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mReturnToStartPositionListener = new C02343();
        this.mShrinkAnimationListener = new C02354();
