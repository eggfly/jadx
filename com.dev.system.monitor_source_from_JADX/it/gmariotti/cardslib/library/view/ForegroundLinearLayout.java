...
public class ForegroundLinearLayout extends LinearLayout {
    ...
    public ForegroundLinearLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mForegroundInPadding = true;
        this.mForegroundBoundsChanged = false;
        TypedArray a = context.obtainStyledAttributes(attrs, C0173R.styleable.ForegroundLinearLayout, defStyle, 0);
        this.mForegroundGravity = a.getInt(C0173R.styleable.ForegroundLinearLayout_android_foregroundGravity, this.mForegroundGravity);
        Drawable d = a.getDrawable(C0173R.styleable.ForegroundLinearLayout_android_foreground);
        if (d != null) {
            setForeground(d);
        }
        this.mForegroundInPadding = a.getBoolean(C0173R.styleable.ForegroundLinearLayout_android_foregroundInsidePadding, true);
        a.recycle();
    }
